...
static const uint8_t cmd9104_hmd_init[] = {
	//LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xef, 0), // Inter Register Enable 2
	LCM_CMD(0xb3, 1), 0x03,
	...
	LCM_CMD(0xb4, 1), 0x21,
	LCM_CMD(0xb1, 1), 0xc0,
	LCM_CMD(0xe6, 2), 0x34,0x27,
	LCM_CMD(0xe7, 2), 0x54,0x27,
	// Set Gamma 1
	LCM_CMD(0xf0, 14), 0x13,0x4d,0x1c,0x5c,
		0x6c,0x2b,0x3f,0x00, 0x00,0x10,0x13,0x10, 0x0d,0x0f,
	// Set Gamma 2
	LCM_CMD(0xf1, 14), 0x01,0x24,0x1c,0x38,
		0x57,0x10,0x3f,0x00, 0x00,0x06,0x05,0x0f, 0x0c,0x0f,
	//LCM_CMD(0xfe, 0), // Inter Register Enable 1
	//LCM_CMD(0xff, 0), // ???
	LCM_CMD(0x11, 0), // Sleep Out Mode
	LCM_DELAY(120),
...
static const uint8_t cmd9307_hmd_init[] = {
	...
	LCM_CMD(0x8d, 1), 0x33,
	LCM_CMD(0x8e, 1), 0x0f,
	LCM_CMD(0xe8, 2), 0x12,0x9f, // Frame Rate
	LCM_CMD(0xff, 1), 0x62,
	LCM_CMD(0x99, 1), 0x3e,
	LCM_CMD(0x9d, 1), 0x4b,
	LCM_CMD(0x98, 1), 0x3e,
	LCM_CMD(0x9c, 1), 0x4b,
	LCM_CMD(0xc3, 1), 0x37, // Power Control 2
	LCM_CMD(0xc4, 1), 0x34, // Power Control 3
	LCM_CMD(0xc9, 1), 0x09, // Power Control 4
	// Set Gamma
	LCM_CMD(0xf0, 6), 0x42,0x00,0x14,0x16,0x0c,0x3a,
	LCM_CMD(0xf2, 6), 0x00,0x00,0x0f,0x17,0x0d,0x2e,
	LCM_CMD(0xf1, 6), 0x50,0xf2,0x85,0x1b,0x31,0x8c,
	LCM_CMD(0xf3, 6), 0x3b,0xf3,0x6f,0x22,0x06,0x9c,
	LCM_CMD(0x35, 1), 0x00, // Tearing Effect Line ON
	LCM_CMD(0x44, 2), 0x00,0x09, // Set Tear Scanline
	LCM_CMD(0x11, 0), // Sleep Out Mode
	LCM_CMD(0x29, 0), // Display ON
	//LCM_CMD(0x2c, 0),
	LCM_END
...
static const uint8_t cmd9306_cat_init[] = {
	//LCM_DELAY(10),
	//LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xef, 0), // Inter Register Enable 2
...
static const uint8_t cmd9305_nokia_init[] = {
	//LCM_DELAY(10),
	//LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xef, 0), // Inter Register Enable 2
	...
	LCM_CMD(0xdf, 1), 0x08,
	LCM_CMD(0xb6, 3), 0x00,0x80,0x27,
	LCM_CMD(0xf0, 6), 0x02,0x02,0x00,0x03,0x07,0x0e,
	LCM_CMD(0xf1, 6), 0x01,0x01,0x00,0x18,0x2e,0x13,
	LCM_CMD(0xf2, 6), 0x0f,0x09,0x2b,0x05,0x05,0x3b,
	LCM_CMD(0xf3, 6), 0x14,0x0d,0x55,0x04,0x02,0x65,
	LCM_CMD(0xf4, 6), 0x0d,0x15,0x14,0x11,0x16,0x0f,
	LCM_CMD(0xf5, 6), 0x02,0x0f,0x0c,0x33,0x36,0x0f,
	LCM_CMD(0xfd, 1), 0x00,
	LCM_CMD(0x2a, 4), 0x00,0x00,0x00,0xef,
	LCM_CMD(0x2b, 4), 0x00,0x00,0x01,0x3f,
	LCM_CMD(0x44, 2), 0x00,0x40,
#if SPI_MODE2
	LCM_CMD(0xe9, 1), 0x08, // SPI 2DATA control
#endif
	LCM_CMD(0x11, 0), // Sleep Out Mode
...
static const uint8_t cmd3025_inoi_init[] = {
	LCM_DELAY(10),
	LCM_CMD(0xff, 1), 0xa5,
	LCM_CMD(0x3e, 1), 0x08,
...
static const uint8_t cmd3001_inoi_init[] = {
	LCM_DELAY(50),
	LCM_CMD(0xfd, 2), 0x06,0x08, // Private access (enter)
	LCM_CMD(0x61, 2), 0x07,0x07,
	LCM_CMD(0x73, 1), 0x70,
	LCM_CMD(0x73, 1), 0x00,
	LCM_CMD(0x62, 3), 0x00,0x44,0x40,
	LCM_CMD(0x63, 4), 0x41,0x07,0x12,0x12,
	LCM_CMD(0x65, 3), 0x09,0x10,0x21,
	LCM_CMD(0x66, 3), 0x09,0x10,0x21,
	LCM_CMD(0x67, 2), 0x21,0x40,
	LCM_CMD(0x68, 4), 0xa5,0x4c,0x45,0x21,
	LCM_CMD(0xb1, 3), 0x0f,0x02,0x02,
	LCM_CMD(0xb4, 1), 0x01,
	LCM_CMD(0xb5, 4), 0x02,0x02,0x0a,0x14,
	LCM_CMD(0xb6, 5), 0x04,0x00,0x9f,0x00,0x02,
	LCM_CMD(0xdf, 1), 0x11,
...
/* QLYX Q8 | --spi_mode 1 --bl_extra rg=0x2f */
	...
	// GlaxyCore GC9307
	X(0x80009307, 240,320, 0x48, NO_TIMINGS, 48000000, cmd9307_qlyx)

/* QLYX Q7 | --spi_mode 1 --bl_extra rgbw=0x16 */

	// GlaxyCore GC9306
	X(0x80009306, 240,320, 0x48, NO_TIMINGS, 48000000, cmd9306_qlyx)

/* Nokia 3210 4G (TA-1618) | --spi_mode 1 --bl_extra rgbw=0x14 */
...
/* Inoi 240 Modern 4G | --bl_extra rgb=0x1f */

	// NewVision NV3023
	X(0x333025, 128,160, 0x00, 50,55,110,20,70,35, 0, cmd3025_inoi)

/* Inoi 244 Modern 4G | --bl_extra rgb=0x1f */

	// NewVision NV3030
	X(0x303001, 240,320, 0x00, 5,150,150,30,80,120, 0, cmd3001_inoi)
};
#undef R128
#undef R160
#undef X

...
LDSCRIPT = $(SYSDIR_T117)/ums9117_fdl2.ld
...
#CFLAGS += -mstrict-align # required when MMU is disabled
...
$(OBJDIR)/sys/%.o: $(SYSDIR_T117)/%.c | objdir
	$(call compile_cc,$(SYS_CFLAGS) -I$(SYSDIR))

$(OBJDIR)/sys/%.o: $(SYSDIR_T117)/%.s | objdir
	$(call compile_asm,)

...
static const uint8_t cmd7C89F0_itel_init[] = {
	//LCM_DELAY(120),
	LCM_CMD(0x11, 0), // Sleep Out Mode
	LCM_DELAY(120),
	LCM_CMD(0xf0, 1), 0x11,
	LCM_CMD(0xf4, 3), 0xca,0x78,0x64,
	LCM_CMD(0xf0, 1), 0x01,
	LCM_CMD(0xb1, 3), 0x0a,0x20,0x20,
	LCM_CMD(0xb2, 3), 0x0a,0x20,0x20,
	LCM_CMD(0xb3, 6), 0x0a,0x20,0x20,0x0a,0x20,0x20,
	LCM_CMD(0xb4, 1), 0x03, // Display Inversion Control
	// Power Control 1-5
	LCM_CMD(0xc0, 3), 0x31,0x11,0x04,
	LCM_CMD(0xc1, 1), 0xc0,
	LCM_CMD(0xc2, 2), 0x0d,0x00,
	LCM_CMD(0xc3, 2), 0x8d,0xea,
	LCM_CMD(0xc4, 2), 0x8d,0xee,
	LCM_CMD(0xc5, 1), 0x08,
	// Set Gamma 1
	LCM_CMD(0xe0, 16), 0x1b,0x21,0x10,0x15,
		0x2b,0x25,0x1f,0x24, 0x24,0x24,0x2b,0x37, 0x00,0x15,0x00,0x38,
	// Set Gamma 2
	LCM_CMD(0xe1, 16), 0x0a,0x20,0x0f,0x15,
		0x2a,0x25,0x1e,0x24, 0x25,0x24,0x2b,0x37, 0x00,0x15,0x00,0x38,
	LCM_CMD(0x3a, 1), 0x05, // Pixel Format Set
	//LCM_CMD(0x2a, 4), 0x00,0x00,0x00,0x7f,
	//LCM_CMD(0x2b, 4), 0x00,0x00,0x00,0x9f,
	//LCM_CMD(0x36, 1), 0xd0, // Memory Access Control
...
static const uint8_t cmd7C89_fly_init[] = {
	LCM_CMD(0x11, 0), // Sleep Out Mode
	LCM_DELAY(120),
	LCM_CMD(0xb1, 3), 0x05,0x3c,0x3c, // Frame Rate Control 1
	LCM_CMD(0xb2, 3), 0x05,0x3c,0x3c, // Frame Rate Control 2
	LCM_CMD(0xb3, 6), 0x05,0x3c,0x3c,0x05,0x3c,0x3c, // Frame Rate Control 3
	LCM_CMD(0xb4, 1), 0x03, // Display Inversion Control
	LCM_CMD(0xc0, 3), 0x28,0x08,0x04,
	LCM_CMD(0xc1, 1), 0xc0, // Power Control 1
	LCM_CMD(0xc2, 2), 0x0d,0x00, // Power Control 2
	LCM_CMD(0xc3, 2), 0x8d,0x2a, // Power Control 3
	LCM_CMD(0xc4, 2), 0x8d,0xee, // Power Control 4
	LCM_CMD(0xc5, 1), 0x14, // Power Control 5
	//LCM_CMD(0x36, 1), 0xc0, // Memory Access Control
	// Set Gamma P
...
static const uint8_t cmd9305_alcatel_init[] = {
	//LCM_DELAY(50),
	LCM_CMD(0xfe, 0), // Inter Register Enable 1
	LCM_CMD(0xef, 0), // Inter Register Enable 2
	//LCM_CMD(0x36, 1), 0x48, // Memory Access Control
	...
	//LCM_CMD(0x2c, 0),
	LCM_CMD(0xf0, 6), 0x02,0x02,0x00,0x0c,0x0e,0x14, // Set Gamma 1
	LCM_CMD(0xf1, 6), 0x01,0x00,0x00,0x28,0x2b,0x02, // Set Gamma 2
	LCM_CMD(0xf2, 6), 0x12,0x0a,0x37,0x04,0x04,0x48, // Set Gamma 3
	LCM_CMD(0xf3, 6), 0x04,0x03,0x43,0x04,0x02,0x50, // Set Gamma 4
	LCM_CMD(0xf4, 6), 0x0b,0x18,0x17,0x1c,0x1e,0x0f, // Set Gamma 5
	LCM_CMD(0xf5, 6), 0x08,0x12,0x13,0x1e,0x1f,0x0f, // Set Gamma 6
	LCM_CMD(0x35, 1), 0x00, // Tearing Effect Line ON
	LCM_CMD(0x44, 2), 0x00,0x10,
	LCM_CMD(0x11, 0), // Sleep Out Mode
	LCM_DELAY(120),
...
static const uint8_t cmd9340_bq_init[] = {
	LCM_CMD(0xb4, 1), 0x00,
	LCM_CMD(0xb7, 7), 0xff,0x44,0x04,0x44,0x04,0x02,0x04,
	LCM_CMD(0xba, 3), 0x22,0x0f,0x20,
	LCM_CMD(0xbb, 3), 0x26,0x77,0x33,
	LCM_CMD(0xcd, 3), 0x26,0x26,0x00,
	LCM_CMD(0xe8, 5), 0x11,0x11,0x33,0x11,0x55,
	LCM_CMD(0xe9, 9), 0x40,0x84,0x65,0x30,0xc0,0x00,0xff,0x00,0x88,
	LCM_CMD(0xea, 7), 0x03,0x22,0x18,0xe2,0x04,0x00,0x00,
	LCM_CMD(0xec, 1), 0x48,
	LCM_CMD(0xf2, 3), 0x00,0x00,0x00,
	LCM_CMD(0xf5, 1), 0xbb,
	//LCM_CMD(0x36, 1), 0x00, // Memory Access Control
	LCM_CMD(0x3a, 1), 0x55, // Interface Pixel Format
	// Positive Gamma Correction
	LCM_CMD(0xe4, 15), 0x00,0x0b,0x11,0x03,0x10,
		0x06,0x37,0x36,0x4c,0x02, 0x0b,0x0a,0x2d,0x34,0x0d,
	// Negative Gamma Correction
	LCM_CMD(0xe5, 15), 0x00,0x0b,0x11,0x04,0x0f,
		0x06,0x37,0x45,0x4c,0x02, 0x0a,0x0a,0x2d,0x34,0x0d,
	LCM_CMD(0x11, 0), // Sleep Out Mode
	LCM_DELAY(120),
	LCM_CMD(0x29, 0), // Display ON
	LCM_END
...
/* Alcatel 2051D */
	...
	// lcd_cmdret(0x04, 4) = 0x00008305
	// lcd_cmdret(0xd3, 4) = 0x10009305

	// GlaxyCore GC9305
	X(0x008305, 240,320, 0x48, 25,250,255/*450*/,50,60,60, 0, cmd9305_alcatel)
};
#undef R128
#undef R160
#undef X
